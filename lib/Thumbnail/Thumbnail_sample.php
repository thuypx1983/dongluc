...
$thumb->img_watermark='../../images/watermark.png';	    // [OPTIONAL] set watermark source file, only PNG format [RECOMENDED ONLY WITH GD 2 ]
...
$thumb->size(640,480);		            // [OPTIONAL] set the biggest width and height for thumbnail
