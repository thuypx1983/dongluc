 ...
 */
function smarty_modifier_select_datetime($id, $value)
{
		if($value=="")
        ...
        $str .= '<input type="text" value="'.$value.'" name="'.$id.'" readonly="readonly"><input type="button" value="Select" onclick="displayCalendar(document.forms[0].'.$id.',\'yyyy-mm-dd hh:ii:ss\',this,true)">';
