...
if ($width  == 0) die('No request WIDTH');
if ($height == 0) die('No request HEIGHT');

$path   = 'upload/no_img/no-image.jpg';

$folder = $width.'x'.$height;

@mkdir("./upload/no_img/" . $folder, 0700);
$thumb  = 'upload/no_img/'.$folder.'/no-img.jpg';
