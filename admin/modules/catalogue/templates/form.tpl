					...
					<table border="0" cellpadding="3" cellspacing="0" style="margin-left:20px;">
						...
						<tr>
						  ...
						  <input name="photo" type="file" id="photo" /><br />
							{if $row.photo!=""}
								<img src="upload/catalogue/thumb/{$row.photo}" style="max-width:500px;" /> <br />
                        ...
                        <!--<tr>
						  <td class="col_left">Giá bán</td>
						  <td>
                          	<input name="price" type="text" value="{$row.price}" />
                            <br>(Nhập ví dụ: "1,000,000 vnđ")
                            <br>(Không nhập sẽ tự hiển thị: "Giá liên hệ")
							</td>
						</tr>-->
						<!--<tr>
						...
						<tr>
						  <td class="col_left">Nội dung<br>(body text)</td>
						  <td>{'content'|ckeditor:$row.content:'Basic'}</td>
						</tr>
