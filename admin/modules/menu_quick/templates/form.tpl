				...
				<div class="TabbedPanelsContent">
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
                        ...
                        <!--<tr>
						  ...
						  <td class="col_right">
							<input name="link_to" type="text" value="{$row.link_to}" size="80" {if $smarty.session.username!=root} disabled {/if} /> 
						  </td>
						</tr>-->
                        <!--<tr>
                        ...
                        <tr>
                            <td class="col_left" valign="top">Ảnh</td>
                            <td class="col_right">
                                <input name="photo" type="file" id="photo" /><br />
                                {if $row.photo!=""}
                                    <img src="upload/menu_quick/thumb/{$row.photo}" /> <br />
