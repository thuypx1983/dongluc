...
{	
	...
	{	
		...
		$this->imagePath = 'upload/category/';
		$this->imageThumb = 'upload/category/thumb/';
	...
	function add()
	{
		if($_SERVER['REQUEST_METHOD']=='POST')
		{
			...
			if($_FILES['thumb']['name']!='') {
				...
				$this->thumbSave($_FILES['thumb']['tmp_name'], $this->imageThumb.$_FILES['thumb']['name'], 252, 158, "");
			}
		...
		$this->smarty->display('product_type_form.tpl');
	}
