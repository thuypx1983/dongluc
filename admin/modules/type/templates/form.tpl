			...
			<div class="TabbedPanelsContentGroup">
				<div class="TabbedPanelsContent">
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
						...
						<tr>
						  <td class="col_left">Tiêu đề Nhật</td>
						  <td class="col_right">
							<input name="title_jp" type="text"  value="{$row.title_jp}" size="80" />
						  </td>
						</tr>
						<tr>
						  <td class="col_left">Đường dẫn</td>
						  <td class="col_right">
							<input name="link" placeholder="Không nhập sẽ tự tạo link" type="text" value="{$row.link}" size="80" /> (Không nhập sẽ tự tạo link)<br />
							{$row.link}
						  </td>
						</tr>
                        <!--<tr>
							<td class="col_left">Nội dung</td>
							<td class="col_right">{'content'|ckeditor:$row.content:'Full':850:300}</td>
						</tr>-->
                        <!--<tr>
						  <td class="col_left">Menu cấp</td>
						  <td class="col_right">
							<input name="menu_level" type="text"  value="{$row.menu_level}" />
						  </td>
						</tr>-->
                        <tr>
                        ...
                        <tr>
						  <td class="col_left"><strong>Hiện điều hướng?</strong></td>
						  <td class="col_right"><input name="is_menu" type="checkbox" value="1" {if $row.is_menu==1} checked="checked"{/if} /></td>
						</tr>
                        <tr style="display:none;">
                            <td class="col_left" valign="top">Photo</td>
                            <td class="col_right">
                                <input name="photo" type="file" id="photo" /><br />
                                {if $row.photo!=""}
                                    <img src="upload/type/{$row.photo}" /> <br />
