			...
			<div class="TabbedPanelsContentGroup">
				<div class="TabbedPanelsContent">
					<table border="0" cellpadding="3" cellspacing="0" style="margin-left:20px;">
                    	<!--<tr>
							<td class="col_left" valign="bottom">Kiểu Album</td>
							<td class="col_right">
								<select name="album_type" {if $smarty.get.task==edit}disabled{/if}>
									<option value="0" {if $row.album_type==0}selected="selected"{/if}>Album về ảnh</option>
									<option value="1" {if $row.album_type==1}selected="selected"{/if}>Album về video</option>
								</select>
							</td>
						</tr>-->
                        <tr>
                          ...
                          <em>Vui lòng chọn ảnh đúng kích thước: 300x186</em><br>
							{if $row.photo!=""}
								<img src="upload/gallery/album/thumb/{$row.photo}" style="max-width:500px;" /> <br />
                        ...
                        <tr>
						  ...
						  <td><textarea name="description" cols="60" rows="5">{$row.description}</textarea></td>
						</tr>
						<tr>
                        ...
                        <tr>
						  <td class="col_left"><strong>Hiện Tr.chủ?</strong></td>
						  <td class="col_right"><input name="is_home" type="checkbox" value="1" {if $row.is_home==1 || $smarty.get.task==add} checked="checked"{/if} /></td>
						</tr>
						<tr>
