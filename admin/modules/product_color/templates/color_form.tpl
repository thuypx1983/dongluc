...
<form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
  <table width="100%" border="0" cellspacing="0" cellpadding="3">
    ...
    <tr>
      <td class="col_left">Tên màu</td>
      <td class="col_right"><input name="title" type="text"  id="name" value="{$row.title}" /></td>
    </tr>
    <tr>
      <td class="col_left">Mã màu</td>
      <td class="col_right">
        <!--<input class="color { required:false }" name="color_code" value="{$row.color_code}">-->
        <input class="color" name="color_code" value="{$row.color_code}">
      </td>
    </tr>
    <tr>
