<?php /* Smarty version Smarty-3.1.7, created on 2015-09-16 11:54:20
         compiled from "admin/modules/about/templates/about_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16852662855f8f5fc00db11-30332135%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a2a2d3e7566212f07734978e890ca3baf81d9e65' => 
    array (
      0 => 'admin/modules/about/templates/about_form.tpl',
      1 => 1432710078,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16852662855f8f5fc00db11-30332135',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55f8f5fc4c75f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55f8f5fc4c75f')) {function content_55f8f5fc4c75f($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_ckeditor')) include '/home/dongluc/public_html/lib/Smarty/plugins/modifier.ckeditor.php';
                    	...
                    	<tr>
                          ...
                          <em>Vui lòng chọn ảnh đúng kích thước 200x130:</em><br>
							<?php if ($_smarty_tpl->tpl_vars['row']->value['photo']!=''){?>
								<img src="upload/about/thumb/<?php echo $_smarty_tpl->tpl_vars['row']->value['photo'];?>
...
" size="70" /></td>
						...
						<tr>
							...
							<td class="col_right"><input name="link" placeholder="Không nhập sẽ tự tạo link" placeholder="Không nhập sẽ tự tạo link" type="text" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['link'];?>
