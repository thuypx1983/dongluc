...
<?php /*%%SmartyHeaderCode:124205587055f6773771b658-63402305%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '124205587055f6773771b658-63402305',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_55f677377974b',
  'variables' => 
  array (
    'url' => 0,
    'config' => 0,
...
<?php if ($_valid && !is_callable('content_55f677377974b')) {function content_55f677377974b($_smarty_tpl) {?><?php if (!is_callable('smarty_function_loadModule')) include '/home/dongluc_dev_oms_vn/public_html/lib/Smarty/plugins/function.loadModule.php';
?><div class="footer pkg">
    <div class="grid1060">
      <ul class="list_footer pkg">
        <li class="col1"><a href="<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
...
images/logo_footer.png"/> </a><br/>
        ...
        <li  class="col2">
          ...
          <p> Fax: <?php echo $_smarty_tpl->tpl_vars['config']->value['fax'];?>
		    ...
		    <?php echo smarty_function_loadModule(array('mod'=>'subcribe','task'=>'footer'),$_smarty_tpl);?>
